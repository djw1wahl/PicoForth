...
void _swap(void)   { M.iA32 = TopP; TopP = M.pstack[M.pidx -1]; M.pstack[M.pidx -1] = M.iA32; }                    // ( a b c - a c b )
void _over(void)   { M.iA32 = M.pstack[M.pidx -1]; PushP = M.iA32; }                                               // ( a b c - a b c b )
void _prot(void)   { M.iC32 = M.pstack[M.pidx -0]; M.iB32 = M.pstack[M.pidx -1]; M.iA32 = M.pstack[M.pidx -2]; \
                     M.pstack[M.pidx -0] = M.iA32; M.pstack[M.pidx -1] = M.iC32; M.pstack[M.pidx -2] = M.iB32; }   // ( a b c - b c a ) 
void _nrot(void)   { M.iC32 = M.pstack[M.pidx -0]; M.iB32 = M.pstack[M.pidx -1]; M.iA32 = M.pstack[M.pidx -2]; \
                     M.pstack[M.pidx -0] = M.iB32; M.pstack[M.pidx -1] = M.iA32; M.pstack[M.pidx -2] = M.iC32; }   // ( a b c - c a b )
...
void _2swap(void)  { M.iA32 = M.pstack[M.pidx -3]; M.iB32 = M.pstack[M.pidx -2]; \
                     M.pstack[M.pidx -3] = M.pstack[M.pidx -1]; M.pstack[M.pidx -2] = M.pstack[M.pidx -0]; \
                     M.pstack[M.pidx -1] = M.iA32; M.pstack[M.pidx -0] = M.iB32; }                                 // ( a b c d - c d a b )
...
void _smod(void)   { M.iA32 = M.pstack[M.pidx-1] % TopP; \
                     M.iB32 = M.pstack[M.pidx-1] / TopP; \
                     M.pidx -= 2; \
                     PushP = M.iA32; PushP = M.iB32; }                                                             // ( x y - x%y x/y )
...
void _bitsand(void) { M.iA32 = M.pstack[M.pidx -1] & M.pstack[M.pidx--]; DecP PushP = M.iA32; }               // ( x y - x&y )
void _bitsor(void)  { M.iA32 = M.pstack[M.pidx -1] | M.pstack[M.pidx--]; DecP PushP = M.iA32; }               // ( x y - x|y )
void _bitsxor(void) { M.iA32 = M.pstack[M.pidx -1] ^ M.pstack[M.pidx--]; DecP PushP = M.iA32; }               // ( x y - x^y )
void _bitsnot(void) { M.iA32 = ~M.pstack[M.pidx--]; PushP = M.iA32; }                                         // ( x - !x )
//
void _tor(void){ }
void _fromr(void){ }
void _rspfetch(void){ }
